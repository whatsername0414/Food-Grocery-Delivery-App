...
import com.vroomvroom.android.databinding.FragmentCancelledBinding
...
@AndroidEntryPoint
class CancelledFragment : BaseFragment<FragmentCancelledBinding>(
    FragmentCancelledBinding::inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ordersViewModel.queryOrdersByStatus("Cancelled")
