...
import com.vroomvroom.android.databinding.FragmentDeliveredBinding
...
class DeliveredFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentDeliveredBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.queryOrdersByStatus("Delivered")
