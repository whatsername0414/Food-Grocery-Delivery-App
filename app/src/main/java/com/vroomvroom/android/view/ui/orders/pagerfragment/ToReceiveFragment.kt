...
import com.vroomvroom.android.databinding.FragmentToReceiveBinding
...
@AndroidEntryPoint
class ToReceiveFragment : BaseFragment<FragmentToReceiveBinding>(
    FragmentToReceiveBinding::inflate
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ordersViewModel.queryOrdersByStatus("To Receive")
